...
import uk.ac.ebi.atlas.search.baseline.FactorAcrossExperiments;
...
public class ExternallyViewableProfilesList<R extends ReportsGeneExpression,
                                            P extends Profile<R, ? extends Expression, ? extends Profile>,
                                            U extends ExpressionUnit> {
    private final GeneProfilesList<P> profiles;
    private final Function<P, URI> provideLinkToProfile;
    private final List<R> prescribedOrderOfColumns;
    ...
    public ExternallyViewableProfilesList(GeneProfilesList<P> profiles,
                                          ...
                                          List<R> prescribedOrderOfColumns,
    ...
    private JsonObject convert(P profile) {
        ...
        for (R c : prescribedOrderOfColumns) {
