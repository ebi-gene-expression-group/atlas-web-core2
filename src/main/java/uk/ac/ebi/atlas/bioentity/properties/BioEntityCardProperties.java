...
public class BioEntityCardProperties {
    ...
    protected BioEntityCardProperties() {
    ...
    private static final Map<BioentityPropertyName, Function<Species, String>> PROPERTY_LINK_MAPPER =
            ImmutableMap.<BioentityPropertyName, Function<Species, String>>builder()
                    ...
                    .put(GO,
                            species -> "https://www.ebi.ac.uk/ols/ontologies/go/terms" +
                                       "?iri=http://purl.obolibrary.org/obo/{0}")
                    .put(GOTERM,
                            species -> "https://www.ebi.ac.uk/ols/search" +
                                       "?q={0}&ontology=go")
                    .put(PO,
                            species -> "https://www.ebi.ac.uk/ols/ontologies/po/terms" +
                                       "?iri=http://purl.obolibrary.org/obo/{0}")
                    .put(POTERM,
                            species -> "https://www.ebi.ac.uk/ols/search" +
                                       "?q={0}&ontology=po")
                    .put(INTERPRO,
                            species -> "https://www.ebi.ac.uk/interpro/entry/{0}")
                    .put(INTERPROTERM,
                            species -> "https://www.ebi.ac.uk/interpro/search" +
                                       "?q={0}")
                    .put(MGI_ID,
                            species -> "http://www.informatics.jax.org/marker/{0}")
                    .put(MGI_DESCRIPTION,
                            species -> "http://www.informatics.jax.org/searchtool/Search.do" +
                                       "?query={0}")
                    .put(ENTREZGENE,
                            species -> "https://www.ncbi.nlm.nih.gov/gene" +
                                       "?term={0}")
                    .put(UNIPROT,
                            species -> "https://www.uniprot.org/uniprot/{0}")
                    .put(ORTHOLOG,
                            species -> "/gxa/genes/{0}")
                    .put(GENE_BIOTYPE,
                            species -> "http://www.ensembl.org/Help/Glossary" +
                                       "?id=275")
                    .put(MIRBASE_ACCESSION,
                            species -> "http://www.mirbase.org/cgi-bin/mirna_entry.pl" +
                                       "?acc={0}")
            .build();
    ...
    public static Set<BioentityPropertyName> linkedPropertynames() {
