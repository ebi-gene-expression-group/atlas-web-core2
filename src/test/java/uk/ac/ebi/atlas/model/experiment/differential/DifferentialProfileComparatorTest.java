...
public class DifferentialProfileComparatorTest {
    ...
    private List<Contrast> mockContrasts = generateRandomContrasts(3, false);
    ...
    private static final List<Contrast> CONTRASTS = generateRandomContrasts(6, false);
    ...
    public void sequenceSpecificAllContrasts() {
        ...
        assertThat(Arrays.asList(sortedGeneNames), containsInAnyOrder(GENE_1, GENE_6, GENE_2, GENE_3, GENE_4, GENE_5));
    }
    ...
    public void sequenceNonSpecificAllContrasts() {
        ...
        String[] sortedGeneNames = extractGeneNames(sortedProfilesArray);
        assertThat(Arrays.asList(sortedGeneNames), containsInAnyOrder(GENE_6, GENE_2, GENE_3, GENE_4, GENE_5, GENE_1));
    }
    ...
    public void sequenceNonSpecificSelectedContrast() {
        ...
        String[] sortedGeneNames = extractGeneNames(sortedProfilesArray);
        assertThat(Arrays.asList(sortedGeneNames), containsInAnyOrder(GENE_2, GENE_3, GENE_6, GENE_4, GENE_5, GENE_1));
    }
