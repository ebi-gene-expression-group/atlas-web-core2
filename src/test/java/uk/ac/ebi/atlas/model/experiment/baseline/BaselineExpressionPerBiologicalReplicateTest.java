    ...
    public void expressionLevelIsTheMedian() {
        ...
        assertThat(
                new BaselineExpressionPerBiologicalReplicate(
                        ImmutableMap.of(
                                BiologicalReplicate.create("assay_1"), new BaselineExpression(1.0))).getLevel(), is(1.0));

        assertThat(
                new BaselineExpressionPerBiologicalReplicate(
                        ImmutableMap.of(
                                BiologicalReplicate.create("assay_1"), new BaselineExpression(1.0),
                                BiologicalReplicate.create("assay_2"), new BaselineExpression(1.0))).getLevel(), is(1.0));

        assertThat(
                new BaselineExpressionPerBiologicalReplicate(
                        ImmutableMap.of(
                                BiologicalReplicate.create("assay_1"), new BaselineExpression(1.0),
                                BiologicalReplicate.create("assay_2"), new BaselineExpression(2.0))).getLevel(), is(1.5));
    ...
    public void toJson() {
        assertThat(
                new BaselineExpressionPerBiologicalReplicate(
                        ImmutableMap.of(
                                BiologicalReplicate.create("assay_1"), new BaselineExpression(1.0),
                                BiologicalReplicate.create("assay_2"), new BaselineExpression(2.0),
