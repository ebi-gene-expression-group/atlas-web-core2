...
public class DifferentialProfileTest {
    ...
    public void addingAnOverExpressedExpressionShouldUpdateMinAndMaxUpRegulatedLevelsAndSpecificity() {
        DifferentialExpression differentialExpressionMock1 = new DifferentialExpression(0.05, 0.4D);
        DifferentialExpression differentialExpressionMock2 = new DifferentialExpression(0.05, 0.6D);
    ...
    public void addingUnderExpressedExpressionsShouldUpdateMinAndMaxDownRegulatedLevelsAndSpecificity() {
        DifferentialExpression differentialExpressionMock1 = new DifferentialExpression(0.05, -0.3D);
        DifferentialExpression differentialExpressionMock2 = new DifferentialExpression(0.05, -0.5D);
    ...
    public void getAverageExpressionLevelOnShouldReturnAverageValueOfOneExpression() {
        DifferentialExpression differentialExpressionMock1 = new DifferentialExpression(0.05, -0.3D);
        DifferentialExpression differentialExpressionMock2 = new DifferentialExpression(0.05, 0.3D);
