...
public class ExternallyAvailableContentServiceTest {
    ...
    private Function<HttpServletResponse, Void> streamFunction = outputStream -> null;
    ...
    private Function<HttpServletResponse, Void> differentStreamFunction = outputStream -> null;
