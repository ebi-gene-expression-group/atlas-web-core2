...
public class ConfigurationTraderTest {
    ...
    public void testGetBaselineFactorsConfiguration() {
        ...
        assertThat(result.getDisclaimer().equals("fortLauderdale"), is(true));
        ...
        assertThat(result.isOrderCurated(), is(true));
    ...
    private void testExperimentalFactorValues(String valueForOrganismPartFactor) {
        mockDataFileHub.addFactorsFile(experimentAccession, Lists.newArrayList(
