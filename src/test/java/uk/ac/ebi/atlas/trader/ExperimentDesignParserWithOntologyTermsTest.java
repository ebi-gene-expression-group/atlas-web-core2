...
public class ExperimentDesignParserWithOntologyTermsTest {
    ...
    private static final OntologyTerm SPECIES_1_ONTOLOGY_TERM =
            OntologyTerm.createFromURI(SPECIES_1_ONTOLOGY_TERM_SOURCEID);

    private static final SampleCharacteristic ASSAY_1_SAMPLE_CHARACTERISTIC_3 =
            SampleCharacteristic.create("Organism", SPECIES_1, SPECIES_1_ONTOLOGY_TERM);
    ...
    private static final String[] FIRST_LINE =
            new String[] {
                    ...
                    "w1118; +; cycCY5",
                    SPECIES_1,
                    SPECIES_1_ONTOLOGY_TERM_SOURCEID,
                    "",
                    CYC_C_MUTANT,
                    ONTOLOGY_TERM_1};
    private static final String CYC = "cyc";
    private static final String[] EMPTY_ONTOLOGY_TERM =
            new String[]{ASSAY_ACCESSION_3, A_AFFY_35, RD_INSTAR_LARVA, CYC, SPECIES_2, "", OREGON_R, CYC, ""};
    private static final String[] LAST_LINE =
            new String[]{
                    ...
                    "wild_type",
                    SPECIES_2,
                    SPECIES_2_ONTOLOGY_TERM_SOURCEID,
                    OREGON_R,
                    "wild_type",
                    ONTOLOGY_TERM_2};
    private static final List<String[]> DATA =
            Lists.newArrayList(HEADER_LINE, FIRST_LINE, EMPTY_ONTOLOGY_TERM, LAST_LINE);
    private static final Factor FACTOR1 =
            new Factor(GENOTYPE, CYC_C_MUTANT, OntologyTerm.create(ONTOLOGY_TERM_1));
    private static final Factor FACTOR2 =
            new Factor(GENOTYPE, "wild_type", OntologyTerm.create(ONTOLOGY_TERM_2));
    private static final String ORGANISM =
            "Organism";
    private static final SampleCharacteristic SC_RABBIT =
            SampleCharacteristic.create(ORGANISM, SPECIES_2);
    private static final Factor FACTOR_GENOTYPE =
    ...
    public void testParseHeaders() {
        ...
        assertThat(
                ...
                contains(CHARACTERISTIC_1, "Genotype", "Organism", CHARACTERISTIC_2));
    }
    ...
    public void testParseSamples() {
        ExperimentDesign experimentDesign = subject.parse(EXPERIMENT_ACCESSION);
        assertThat(
                experimentDesign.getSampleCharacteristic(ASSAY_ACCESSION_1, CHARACTERISTIC_1).getValue(),
                is(RD_INSTAR_LARVA));
        assertThat(
                experimentDesign.getSampleCharacteristic(ASSAY_ACCESSION_2, CHARACTERISTIC_1).getValue(),
                is(RD_INSTAR_LARVA));
        assertThat(experimentDesign.getSampleCharacteristic(ASSAY_ACCESSION_1, CHARACTERISTIC_2).getValue(), is(""));
        assertThat(experimentDesign.getSampleCharacteristic(ASSAY_ACCESSION_2, CHARACTERISTIC_2).getValue(), is(OREGON_R));
        assertThat(experimentDesign.getSampleCharacteristic(ASSAY_ACCESSION_1, DUMMY), is(nullValue()));
        assertThat(experimentDesign.getSampleCharacteristic(DUMMY, CHARACTERISTIC_1), is(nullValue()));

        SampleCharacteristic sampleCharacteristic =
                experimentDesign.getSampleCharacteristic(ASSAY_ACCESSION_1, CHARACTERISTIC_3);
        assertThat(sampleCharacteristic.getHeader().equals(ASSAY_1_SAMPLE_CHARACTERISTIC_3.getHeader()), is(true));
        assertThat(sampleCharacteristic.getValue().equals(ASSAY_1_SAMPLE_CHARACTERISTIC_3.getValue()), is(true));
        assertThat(sampleCharacteristic.getValueOntologyTerms().isEmpty(), is(false));

        OntologyTerm ontologyTerm = sampleCharacteristic.getValueOntologyTerms().iterator().next();
    ...
    public void testGetAllRunOrAssay() {
        ...
        assertThat(
                ...
                contains(ASSAY_ACCESSION_3, ASSAY_ACCESSION_1, ASSAY_ACCESSION_2));
    }
