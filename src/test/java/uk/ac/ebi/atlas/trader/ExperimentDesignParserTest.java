...
public class ExperimentDesignParserTest {
    ...
    public void testParseSamples() {
        ExperimentDesign experimentDesign = subject.parse(EXPERIMENT_ACCESSION);
        assertThat(
                experimentDesign.getSampleCharacteristic(ASSAY_ACCESSION_1, SAMPLE_NAME_1).getValue(),
                is(RD_INSTAR_LARVA));
        assertThat(
                experimentDesign.getSampleCharacteristic(ASSAY_ACCESSION_2, SAMPLE_NAME_1).getValue(),
                is(RD_INSTAR_LARVA));
        assertThat(experimentDesign.getSampleCharacteristic(ASSAY_ACCESSION_1, SAMPLE_NAME_2).getValue(), is(""));
        assertThat(experimentDesign.getSampleCharacteristic(ASSAY_ACCESSION_2, SAMPLE_NAME_2).getValue(), is(OREGON_R));
        assertThat(experimentDesign.getSampleCharacteristic(ASSAY_ACCESSION_1, DUMMY), is(nullValue()));
        assertThat(experimentDesign.getSampleCharacteristic(DUMMY, SAMPLE_NAME_1), is(nullValue()));
    }
