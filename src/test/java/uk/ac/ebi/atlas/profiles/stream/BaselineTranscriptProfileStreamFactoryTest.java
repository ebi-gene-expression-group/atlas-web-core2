...
public class BaselineTranscriptProfileStreamFactoryTest {
    ...
    private static final BiologicalReplicate ASSAY_1 = BiologicalReplicate.create("assay_1");
    private static final BiologicalReplicate ASSAY_2 = BiologicalReplicate.create("assay_2");
    private static final BiologicalReplicate ASSAY_3 = BiologicalReplicate.create("assay_3");
